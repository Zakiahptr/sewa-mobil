@extends('include.app' , ['title' => 'Dasbor'])
                        ...
                        <table id="datatable" class="table table-striped table-bordered" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $car->plat }}</td>
                                    <td>{{ $car->price }}</td>
                                    <td><a href="{{ route('rent.create', $car->id )}}" class="btn btn-primary" data-toggle="tooltip" title="Pinjam"><i class="fas fa-plus mr-2"></i> Pinjam</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
